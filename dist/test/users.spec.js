...
describe('Test for user endpoints for Ride-my-way ride API', function () {
  ...
  describe('GET all users', function () {
    it('should return an array of all users', function (done) {
      _chai2.default.request('https://ride-my-way-andela.herokuapp.com').get('/api/v1/users').set('Accept', 'application/json').set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', 'Bearer ' + token).end(function (err, res) {
  ...
  describe('GET one user', function () {
    it('should return an object of one user', function (done) {
      _chai2.default.request('https://ride-my-way-andela.herokuapp.com').get('/api/v1/users/4574ea40-804c-11e8-b48e-37c57163b62d').set('Accept', 'application/json').set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', 'Bearer ' + token).end(function (err, res) {
        (0, _chai.expect)(err).to.equal(null);
        (0, _chai.expect)(res.status).to.equal(200);
        (0, _chai.expect)(res.body.status).to.equal('success');
  ...
  describe('UPDATE update user profile', function () {
    it('should return an success with object of updated resources', function (done) {
      _chai2.default.request('https://ride-my-way-andela.herokuapp.com').put('/api/v1/users/4574ea40-804c-11e8-b48e-37c57163b62d').set('Accept', 'application/json').set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', 'Bearer ' + token).send({
        name: 'Tolu mide',
  ...
  describe('UPDATE update user password', function () {
    it('should return success', function (done) {
      _chai2.default.request('https://ride-my-way-andela.herokuapp.com').put('/api/v1/users/4574ea40-804c-11e8-b48e-37c57163b62d/password').set('Accept', 'application/json').set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', 'Bearer ' + token).send({
  ...
  describe('UPDATE update user photo', function () {
    it('should return success', function (done) {
      _chai2.default.request('https://ride-my-way-andela.herokuapp.com').put('/api/v1/users/4574ea40-804c-11e8-b48e-37c57163b62d/photo').set('Accept', 'application/json').set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', 'Bearer ' + token).send({
